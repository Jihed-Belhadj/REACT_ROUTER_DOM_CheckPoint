...
function App() {
  ...
  const [MovieSch, setMovieSch] = useState('')
...
<NavB MovieSch={MovieSch} setMovieSch={setMovieSch} Rating={Rating} setRating={setRating} Hide={Hide} setHide={setHide} />
      <Routes>
      <Route path='/home' element={<Home/>}/>
      <Route path='/movies' element={<MoviesList Tab={Tab} setTab={setTab} MovieSch={MovieSch} setRating ={setRating} Rating={Rating} />}/>
      <Route path='/movies/details/:id' element={<Details Tab={Tab} />}/>
      </Routes>
    </div>
  );
}
